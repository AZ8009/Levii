...
local Window = OrionLib:MakeWindow({Name = "LEVI SCRIPT", HidePremium = false, SaveConfig = true, ConfigFolder = "LEVI"})
...
Tab:AddButton({
	Name = "طيران",
	Callback = function()
loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Fly-Gui-V3-17541"))()
  	end    
})
...
ca.Font=Enum.Font.SourceSansSemibold;ca.Text=" سكربت ليفاي  !"ca.TextColor3=Color3.new(0,1,1)
...
local Section = Tab:AddSection({
	Name = "بس يرجعلي الشغف اسوي اقوى سكربت بتاريخ الصملاويين"
})

Tab:AddLabel("من الممكن بعض سكربتات غير شغاله")
...
local Section = Tab:AddSection({
	Name = "تنبية بعض سكربتات تحتاج VPN! "
})
...
Tab:AddButton({
	Name = "سكربت L7N",
	Callback = function()
loadstring(game:HttpGet('https://pastebin.com/raw/ZRMafR0A'))()
  	end    
})

Tab:AddButton({
	Name = "سكربت L7N الثاني",
	Callback = function()
loadstring(game:HttpGet('https://pastebin.com/raw/P64x0Tfi'))()
  	end    
})

Tab:AddButton({
	Name = "سكربت L7N الثالث) المفتاح/L7N_ON_TOP) ",
	Callback = function()
...
Tab:AddButton({
	Name = "سكربت سبراني(المفتاح/sebraniun) ",
	Callback = function()
...
local Section = Tab:AddSection({
	Name = "سكربت تم انشاءه لنيك اعداء هيثم ويا كرار بطلع قحبه اذا ما انيك اختك وداني ساعدني ببعض سكربتات"
